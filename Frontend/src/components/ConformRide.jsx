...
function ConformRide(props) {
  ...
  switch (props.carType) {
    ...
    case 'auto':
      ...
      break;
    default:
      imageUrl = ''; // Default image or empty if no match
  }
  return (
    <div>
      <h2 className="text-xl font-semibold text-center p-3">Conform Ride</h2>
      ...
      <div className="flex items-center gap-5 p-1">
        ...
        <div>
          ...
          <p className="text-gray-600">{props.picup}.</p>
        </div>
      </div>
      <div className="flex items-center gap-5 p-1">
        ...
        <div>
          ...
          <p className="text-gray-600">{props.dropoff}.</p>
        </div>
      </div>
      <div className="flex items-center gap-3 p-1">
      <i className="ri-money-rupee-circle-fill"></i>
      <div>
          <h3 className="text-lg font-medium">{props.fare[props.carType]}</h3>
      ...
      <button onClick={()=>{
        ...
        props.createRide();
      }} className=" text-center w-full text-lg font-medium bg-blue-600 hover:bg-blue-700 text-white p-2 rounded-md">Confirm</button>
    </div>
  );
}
